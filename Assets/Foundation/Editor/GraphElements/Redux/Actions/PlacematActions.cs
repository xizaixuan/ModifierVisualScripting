...
namespace Unity.Modifier.GraphElements
{
    ...
    public class ChangePlacematTitleAction : GenericPlacematAction<string>
    {
        public ChangePlacematTitleAction(string title, IGTFPlacematModel placematModel)
            : base(new[] { placematModel }, title) { }

        public static TState DefaultReducer<TState>(TState previousState, ChangePlacematTitleAction action) where TState : State
        {
