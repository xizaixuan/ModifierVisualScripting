...
namespace Unity.Modifier.GraphElements
{
    public class BlackboardSection : GraphElement
    {
        ...
        private void SetDragIndicatorVisible(bool visible)
        {
            ...
            {
                hierarchy.Add(m_DragIndicator);
                m_DragIndicator.style.visibility = StyleKeyword.Null;
            }
        ...
        private void OnDragUpdatedEvent(DragUpdatedEvent evt)
        {
            ...
            if (m_InsertIndex != -1)
            {
                ...
                m_DragIndicator.SetLayout(new Rect(0, indicatorY - m_DragIndicator.layout.height / 2, layout.width, m_DragIndicator.layout.height));
            }
            else
            {
                SetDragIndicatorVisible(false);
