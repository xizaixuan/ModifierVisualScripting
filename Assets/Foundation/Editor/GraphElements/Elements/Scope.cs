...
namespace Unity.Modifier.GraphElements
{
    public partial class Scope : GraphElement
    {
        ...
        public Rect containedElementsRect { get { return m_ContentContainer.ChangeCoordinatesTo(this, m_ContentContainer.GetRect()); } }

        public Scope()
        {
            var visualTree = GraphElementsHelper.LoadUXML("Scope.uxml");

            this.AddStylesheet("Scope.uss");
        ...
        {
            if (element == null)
                throw new ArgumentException("Connot ass null element");
        ...
        public void UpdateGeometryFromContent()
        {
            ...
            try
            {
                ...
                m_ContentContainer.MarkYogaNodeDirty();

                // Force the layout to be computed right away
                this.ForceComputeYogaNodeLayout();

                this.MarkYogaNodeSeen();
        ...
        public override void SetPosition(Rect newPos)
        {
            ...
            else
            {
                ...
                // Moves the contained elements by the same disaplacement
                MoveElements(delta);
            }
        }
