    ...
    public class RectangleSelector : MouseManipulator
    {
        ...
        private class RectangleSelect : ImmediateModeElement
        {
            ...
            protected override void ImmediateRepaint()
            {
                ...
                var str = "(" + String.Format(CultureInfo.InvariantCulture.NumberFormat, "{0:0}", start.x) + ", " + String.Format(CultureInfo.InvariantCulture.NumberFormat, "{0:0}", start.y) + ")";
                GUI.skin.label.Draw(new Rect(screenStart.x, screenStart.y - 18.0f, 200.0f, 20.0f), new GUIContent(str), 0);
                str = "(" + String.Format(CultureInfo.InvariantCulture.NumberFormat, "{0:0}", end.x) + ", " + String.Format(CultureInfo.InvariantCulture.NumberFormat, "{0:0}", end.y) + ")";
