...
namespace Unity.Modifier.GraphElements
{
    public class GridBackground : ImmediateModeElement
    {
        ...
        private Color lineColor => m_LineColor * GraphViewStaticBridge.EditorPlayModeTint;

        Color m_ThickLineColor = s_DefaultThickLineColor;
        private Color thickLineColor => m_ThickLineColor * GraphViewStaticBridge.EditorPlayModeTint;

        Color m_GridBackgroundColor = s_DefaultGridBackgroundColor;
        private Color gridBackgroundColor => m_GridBackgroundColor * GraphViewStaticBridge.EditorPlayModeTint;
